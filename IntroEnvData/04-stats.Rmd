...
Lara _et al._ looked at the impact of lemmings by using a long term fenced exclosure that kept lemmings out (pictured example below) for more than 50 years. The authors found that there were sufficient lemming population outbreaks in frequent intervals to properly capture long-term lemming impacts on the ecosystem. 
