...
Let's think a little more about how this urban/rural variable and how to interpret it in a regression. Keep in mind that urban built environments can have surfaces that are typically much warmer than surrounding natural vegetated environments. Dark paved surfaces and buildings absorb greater levels of solar radiation, resulting in higher temperatures in the immediate urban area. Remember urban sites will be marked with a one and rural areas are marked with a zero.  Consider the interpretation of the slope coefficient _x~1~_ versus _x~0~_.  Remember urban sites will be marked with a one and rural areas are marked with a zero. 
