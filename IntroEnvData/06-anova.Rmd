...
_______|____________________|________________|_____________|_________|________
Among groups | _a-1_ | $\sum_{i=1}^{a} \sum_{j=1}^{n}(\overline{Y_i}-\overline{Y})^{2}$ | $\frac{SS_{among}}{a-1}$ | $\frac{MS_{among}}{MS_{within}}$ | p(F-distribution with (_a-1_) and _a(n-1)_ degrees of freedom) 
